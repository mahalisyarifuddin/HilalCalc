...
- `Phase Shift` = -3.3228107 (7 digit desimal)
- `Inverse Offset` = 4.3228107 (1.0 - Phase Shift, untuk konsistensi bolak-balik)

## Akurasi
- **Rentang**: 1000 H hingga 6000 H (60000 bulan).
- **Kecocokan Tepat (Awal Bulan)**: 43492 (72.49%).
- **Akurasi Bulan Wajib**: ~72.62% (Ramadhan, Syawal, Dzulhijjah).
