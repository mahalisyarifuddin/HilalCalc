...
- `Phase Shift` = -3.2913238 (7 decimal digits)
- `Inverse Offset` = 4.2913238 (1.0 - Phase Shift, for round-trip consistency)

## Accuracy
- **Range**: 1000 AH to 6000 AH (60000 months).
- **Exact Matches (Month Starts)**: 43113 (71.86%).
- **Obligatory Months Accuracy**: ~71.91% (Ramadan, Shawwal, Dhu al-Hijjah).
