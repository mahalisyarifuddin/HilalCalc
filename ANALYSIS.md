...
- `Phase Shift` = 0.3733791285 (to maximize integer floor accuracy)
- `Inverse Offset` = 0.6266208715 (1.0 - Phase Shift, for round-trip consistency)

## Accuracy
- **Range**: 1400 AH to 1500 AH (1200 months).
- **Exact Matches (Month Starts)**: 877 (73.08%).
