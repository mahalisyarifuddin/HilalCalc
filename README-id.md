...
-   **Heuristik Dinamis**: Secara otomatis menghitung koefisien Tabular (`C`) yang optimal berdasarkan bujur Anda (misal `C=15` untuk Aceh, `C=10` untuk Mekkah) untuk konversi tanggal yang akurat.
