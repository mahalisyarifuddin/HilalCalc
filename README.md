...
-   **Dynamic Heuristics**: Automatically calculates the optimal Tabular coefficient (`C`) based on your longitude (e.g., `C=14` for Aceh, `C=9` for Mecca) for accurate date conversion.
