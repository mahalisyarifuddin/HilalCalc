...
-   **Multiple Criteria**: Support for MABBIMS (Min Alt 3°, Min Elong (Ecliptic) 6.4°), Global Islamic Calendar (GIC), and custom criteria.
...
- **MABBIMS (2021)**: Primarily used in Southeast Asia (Brunei, Indonesia, Malaysia, Singapore).
  - **Thresholds**: Altitude (Topocentric) ≥ 3°, Elongation (Ecliptic) ≥ 6.4°.
  - **Reference**: Grid search across the Indonesian archipelago (95° E to 141° E).
- **GIC (2016)**: The Global Hijri Calendar criteria adopted in Istanbul.
  - **Thresholds**: Altitude (Geocentric) ≥ 5°, Elongation (Ecliptic) ≥ 8°.
  - **Timeline**: Visibility must be achieved anywhere globally before Fajr in Wellington, New Zealand. Matches in the Americas (-140° to -30° Lon) after midnight UTC are accepted if conjunction preceded the NZ deadline.
