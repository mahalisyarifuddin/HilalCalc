...
**Accuracy:**
This simple linear formula achieves **~72.8%** exact match accuracy for month starts against the astronomical Ground Truth over the 500-year period (1400-1900 AH). For detailed documentation on the methodology and data, see [GT_1400_1900.md](GT_1400_1900.md).
