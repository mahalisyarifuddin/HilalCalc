...
async function main() {
    console.log(`\n${'='.repeat(70)}`);
    console.log(`TABULAR HIJRI CALENDAR OPTIMIZATION (OBLIGATORY MONTHS)`);
    console.log(`Analyzing years ${startYear}-${endYear} AH (${endYear - startYear + 1} years, ${(endYear - startYear + 1) * months.length} months)`);
    ...
    for (const loc of locations) {
        ...
        // Calculate Ground Truths for OBLIGATORY months
